...
const styles = theme => ({
    ...
    root: {
        ...
        height: '70vh',
        padding: '320px 480px',
        backgroundImage: "url('https://homefolio.s3-us-west-2.amazonaws.com/frontpagelarge.jpg')",
        textAlign: "center",
    },
    paper1: {
        margin: 'auto',
        ...
        padding: '160px 160px',
        height: '320px',
        backgroundImage: "url('https://homefolio.s3-us-west-2.amazonaws.com/front1.jpg')",
        textAlign: 'center',
        opacity: '0.7',
    },
    paper2: {
        ...
        padding: '160px 160px',
        height: '320px',
        backgroundImage: "url('https://homefolio.s3-us-west-2.amazonaws.com/front2.jpg')",
        textAlign: 'center',
        opacity: '0.7',
    },
    paper3: {
        ...
        padding: '160px 160px',
        height: '320px',
        backgroundImage: "url('https://homefolio.s3-us-west-2.amazonaws.com/front3.jpg')",
        textAlign: 'center',
        opacity: '0.7',
    },
    text: {
